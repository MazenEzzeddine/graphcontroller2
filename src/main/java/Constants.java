   ...
   static List<String> getQueriesArrival(String topicName) {
       List<String> queries = new ArrayList<>();
         ...
         String topic1p0 = "http://prometheus-operated:9090/api/v1/query?" +
                "query=sum(rate(kafka_topic_partition_current_offset%7Btopic=%22"+ topicName+ "%22,partition=%220%22,namespace=%22default%22%7D%5B5s%5D))";
         String topic1p1 = "http://prometheus-operated:9090/api/v1/query?" +
                "query=sum(rate(kafka_topic_partition_current_offset%7Btopic=%22"+ topicName+ "%22,partition=%221%22,namespace=%22default%22%7D%5B5s%5D))";
         String topic1p2 = "http://prometheus-operated:9090/api/v1/query?" +
                "query=sum(rate(kafka_topic_partition_current_offset%7Btopic=%22"+ topicName+ "%22,partition=%222%22,namespace=%22default%22%7D%5B5s%5D))";
         String topic1p3 = "http://prometheus-operated:9090/api/v1/query?" +
                "query=sum(rate(kafka_topic_partition_current_offset%7Btopic=%22"+ topicName+ "%22,partition=%223%22,namespace=%22default%22%7D%5B5s%5D))";
         String topic1p4 = "http://prometheus-operated:9090/api/v1/query?" +
                "query=sum(rate(kafka_topic_partition_current_offset%7Btopic=%22"+ topicName+ "%22,partition=%224%22,namespace=%22default%22%7D%5B5s%5D))";
